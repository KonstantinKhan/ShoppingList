...
data class TgUser(
    ...
    companion object {
        val FULL_USER =
            TgUser(userId = 123456, isBot = false, firstName = "first", lastName = "last", userName = "name")
        val PART_USER = TgUser(userId = 123456, isBot = false, firstName = "first")
        ...
        val USER_FROM_FULL_JSON = json.decodeFromJsonElement<TgUser>(USER_FULL_JSON)
        val USER_FROM_PART_JSON = json.decodeFromJsonElement<TgUser>(USER_PART_JSON)
        val USER_FROM_REDUNDANT_PROPERTIES_JSON = json.decodeFromJsonElement<TgUser>(USER_REDUNDANT_PROPERTIES_JSON)
    }
}
